...
class Poloniex:
	...
	def api_query(self, command, req={}):
		...
		if command == "returnTicker" or command == "return24Volume":
			...
			post_data = bytes(urllib.parse.urlencode(req), 'utf-8')

			sign = hmac.new(bytes(self.Secret, 'utf-8'), post_data, hashlib.sha512).hexdigest()
			headers = {'Sign': sign, 'Key': bytes(self.APIKey, 'utf-8')}
